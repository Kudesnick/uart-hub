...
#define MX_CAN2_RX_GPIO_PuPd            GPIO_PULLUP
...
#define MX_CAN2_TX_GPIO_PuPd            GPIO_PULLUP
...
#define MX_CAN3_RX_GPIO_PuPd            GPIO_PULLUP
...
#define MX_CAN3_TX_GPIO_PuPd            GPIO_PULLUP
