...
__PACKED_STRUCT param_header_t
{
    ...
    uint16_t secure_flag : HEADER_FIELD_LEN_SECURE ; // ѕрава доступа (param_secure_flag_t)
    uint16_t state       : HEADER_FIELD_LEN_STATE  ; // ѕоле состо€ни€ / размера данных (PARAM_DATA_TYPE_t)
};
