...
//   <o>Global Dynamic Memory size (in Bytes) <0x0-0xFFFFFFFF:8>
//   <i> Defines the combined global dynamic memory size (Debug Access Port not include)
//   <i> Default: 0x1000
#ifndef OS_DYNAMIC_MEM_SIZE
#define OS_DYNAMIC_MEM_SIZE       0xA000
#endif
...
//   <o>Default Thread Stack size (in Bytes) <0x0-0xFFFFFFFF:8>
//   <i> Defines stack size for threads with zero stack size specified.
//   <i> Default: 0x100
#ifndef OS_STACK_SIZE
#define OS_STACK_SIZE              0x400
#endif
 
//   <o>Idle Thread Stack size (in Bytes) <0x0-0xFFFFFFFF:8>
...
//   <o>Timer Thread Stack size (in Bytes) <0x0-0xFFFFFFFF:8>
//   <i> Defines stack size for Timer thread.
//   <i> May be set to 0 when timers are not used.
//   <i> Default: 0x100
#ifndef OS_TIMER_THREAD_STACK_SIZE
#define OS_TIMER_THREAD_STACK_SIZE  0x0001000
#endif
